# Adapted from: https://raw.githubusercontent.com/lisa-lab/DeepLearningTutorials/master/code/test.py
...
def speed():
    """
    This function modifies the configuration theano and don't restore it!
    """
